            ...
            [
                [
                    InlineKeyboardButton(
                        "- قـنـاة الـسـورس .", url="https://t.me/APP_YOUTUBE",
                    )
                ],
                ...
                [
                    ...
                    InlineKeyboardButton(
                        "- قـنـاة الـبـوت .", url=f"https://t.me/{UPDATES_CHANNEL}"
                    ),
                ],
                [
                    InlineKeyboardButton(
...
async def start(client: Client, message: Message):
    await message.reply_photo(
        photo=f"https://j.top4top.io/p_236564zho0.jpg",
        ...
        reply_markup=InlineKeyboardMarkup(
         [
            ...
            [
                InlineKeyboardButton(
                    "- قـنـاة الـسـورس .", url=f"https://t.me/APP_YOUTUBE"
                ),
            ],
            [
                InlineKeyboardButton("- ضـيـف الـبـوت لـمـجـموعـتـك .", url=f"https://t.me/{BOT_USERNAME}?startgroup=true"),
            ]
         ]
     )
  )
